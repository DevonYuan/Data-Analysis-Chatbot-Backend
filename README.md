...
## Tech Stack 
**Backend:** FastAPI, Pandas (Data analysis), jose (JWT based authentication), psycopg2 (Database connection), bcrypt (Hashing passwords) <br>
**Frontend:** React + Vite (Javascript), React 3F and Drei (Visuals), React Router <br>
